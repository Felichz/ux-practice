...
const CheckboxGroupTemplate: StoryFn<CheckboxProps> = (args) => (
  <>
    <Checkbox {...args} icon={GearIcon} />
    <br />
    <Checkbox {...args} icon={CartIcon} />
    <br />
    <Checkbox {...args} icon={DeliveryIcon} />
  </>
);

const AllCheckboxesTemplate: StoryFn<CheckboxProps> = (args) => (
  <>
    <Checkbox {...args} />
    <br />
    <Checkbox {...args} status="error" />
    <br />
    <Checkbox {...args} status="warning" />
    <br />
    <Checkbox {...args} status="success" />
    <br />
...
export const WithIcon = CheckboxGroupTemplate.bind({});
WithIcon.args = {
  label: 'Checkbox with Icon',
};

export const SizeLarge = AllCheckboxesTemplate.bind({});
SizeLarge.args = {
  label: 'Size Large',
  size: 'lg',
};

export const SizeMedium = AllCheckboxesTemplate.bind({});
SizeMedium.args = {
  label: 'Size Medium',
  size: 'md',
};
